        ...
        <div className='homepage'>
          <section className='home-sections'>
            ...
            <p className='style-text'>
              ...
              and drop kanban style dashboard. To get started head to the
              services page and request a service. You can then log in to the
              admin Dashboard with Username: admin Password: pass to take a look
              at your submitted request and use the drag and drop features to
